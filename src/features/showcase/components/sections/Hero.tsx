  ...
  return (
    <section className="relative min-h-[600px] md:h-screen md:min-h-[700px] flex items-center pt-20 overflow-hidden">
      ...
      <Container className="relative z-10 text-white text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
          <div className="inline-block border-y border-showcase-primary py-2 px-8 mb-6">
            <span className="text-sm font-bold uppercase tracking-[0.3em] text-showcase-primary">Kiến Tạo Không Gian Sống</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold leading-tight" style={{ fontFamily: "'Inter', sans-serif" }}>
            NỘI THẤT CAO CẤP <br /> NÂNG TẦM ĐIỂM SỐNG
          </h1>
          <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto font-light leading-relaxed">
            Chúng tôi mang đến sự hoàn hảo trong từng chi tiết, từ thiết kế ý tưởng đến khi hiện thực hóa giấc mơ về một tổ ấm sang trọng và tiện nghi.
          </p>
      ...
      <div className="absolute -bottom-14 left-1/2 -translate-x-1/2 z-20 hidden md:flex bg-white shadow-xl rounded-t-lg overflow-hidden border-t-4 border-showcase-primary">
        <button className="px-8 py-4 text-sm font-bold uppercase tracking-wider text-teal-900 border-r border-gray-100 bg-gray-50" style={{ fontFamily: "'Inter', sans-serif" }}>Thiết Kế Biệt Thự</button>
        <button className="px-8 py-4 text-sm font-bold uppercase tracking-wider text-gray-400 hover:text-teal-900 transition-colors" style={{ fontFamily: "'Inter', sans-serif" }}>Thiết Kế Chung Cư</button>
      </div>
    </section>
  );
};

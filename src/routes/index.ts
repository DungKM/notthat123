...
export const ROUTES = {
  ...
  CONG_TRINH: '/thiet-ke-noi-that',
  THIET_KE_KIEN_TRUC: '/thiet-ke-kien-truc',
  CHI_TIET_KIEN_TRUC: '/thiet-ke-kien-truc/:slug',
  CHI_TIET_CONG_TRINH: '/thiet-ke-noi-that/:slug',
  ...
  ADMIN_DANH_MUC_CONG_TRINH: '/quan-tri/danh-muc-cong-trinh',
  ADMIN_QUAN_LY_TUYEN_DUNG: '/quan-tri/tuyen-dung-noi-bo',
  ADMIN_QUAN_LY_LIEN_HE: '/quan-tri/quan-ly-lien-he',
  ...
  ADMIN_CAI_DAT_CONG_TY: '/quan-tri/cai-dat-cong-ty',
  ADMIN_MAU_SAC: '/quan-tri/mau-sac',
};
